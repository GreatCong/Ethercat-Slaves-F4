...
#define ECAT_TIMER_ACK_INT        		 	__HAL_TIM_CLEAR_FLAG(&htim5 , TIM_SR_UIF)//TIM_ClearITPendingBit(TIM2 , TIM_FLAG_Update);	
...
#define STOP_ECAT_TIMER              	HAL_TIM_Base_Stop(&htim5)//TIM_Cmd(TIM2, DISABLE);	

#define START_ECAT_TIMER           		HAL_TIM_Base_Start(&htim5) //TIM_Cmd(TIM2, ENABLE);				
