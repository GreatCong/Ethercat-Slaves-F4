...
#define PVM_MODULE_ID           0x00419800 /**< \brief Module Id for profile velocity mode*/
#define PTM_MODULE_ID           0x00519800 /**< \brief Module Id for profile torque mode*/
 ...
 * pvm     mode RxPDO mapping : 0x1603<br>
 * ptm     mode RxPDO mapping : 0x1604<br>
 * csp/csv mode TxPDO mapping : 0x1A00<br>
 * csp     mode TxPDO mapping : 0x1A01<br>
 * csv     mode TxPDO mapping : 0x1A02<br>
 * pvm     mode TxPDO mapping : 0x1A03<br>
 * ptm     mode TxPDO mapping : 0x1A04
 * @{
 */
...
/** \brief 0x1603 (pvm RxPDO) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
...
/** \brief 0x1604 (ptm RxPDO) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
...
/** \brief 0x1A03 (pvm TxPDO) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[2]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
...
/** \brief 0x1A04 (ptm TxPDO) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[2]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
...
/** \brief Data structure to handle the process data transmitted via 0x1A03 (pvm TxPDO)*/
typedef struct STRUCT_PACKED_START
{
    UINT16 ObjStatusWord; /**< \brief Status word (0x6041)*/
    INT32 objVelocityActualValue; /**< \brief Actual Velocity (0x606C)*/
...
/** \brief Data structure to handle the process data transmitted via 0x1A04 (ptm TxPDO)*/
typedef struct STRUCT_PACKED_START
{
    UINT16 ObjStatusWord; /**< \brief Status word (0x6041)*/
...
/** \brief Data structure to handle the process data transmitted via 0x1603 (pvm RxPDO)*/
typedef struct STRUCT_PACKED_START
{
    UINT16 ObjControlWord; /**< \brief Control word (0x6040)*/
    INT32 ObjTargetVelocity; /**< \brief Target velocity (0x60FF)*/
...
/** \brief Data structure to handle the process data transmitted via 0x1604 (ptm RxPDO)*/
typedef struct STRUCT_PACKED_START
{
    UINT16 ObjControlWord; /**< \brief Control word (0x6040)*/
...
typedef struct OBJ_STRUCT_PACKED_START
{
    ...
    TOBJ1602 sRxPDOMap2; /**< \brief csv RxPDO (0x1602)*/
	  TOBJ1603 sRxPDOMap3; /**< \brief pvm RxPDO (0x1603)*/
    TOBJ1604 sRxPDOMap4; /**< \brief ptm RxPDO (0x1604)*/
    ...
    TOBJ1A02 sTxPDOMap2; /**< \brief csv TxPDO (0x1A02)*/
	  TOBJ1A03 sTxPDOMap3; /**< \brief pvm TxPDO (0x1A03)*/
    TOBJ1A04 sTxPDOMap4; /**< \brief ptm TxPDO (0x1A04)*/
...
/**
 * \brief Object 0x1603 (pvm RxPDO) entry descriptions
 */
...
/**
 * \brief Object 0x1603 (pvm RxPDO) object and entry names
 *
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */      
OBJCONST UCHAR OBJMEM aName0x1603[] = "pvm RxPDO\000\377";
	 
	 
/**
 * \brief Object 0x1604 (ptm RxPDO) entry descriptions
 */
...
/**
 * \brief Object 0x1604 (ptm RxPDO) object and entry names
 *
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */      
OBJCONST UCHAR OBJMEM aName0x1604[] = "ptm RxPDO\000\377";
...
/**
 * \brief Object 0x1A01 (csp TxPDO) entry descriptions
 */
...
/**
 * \brief Object 0x1A02 (csv TxPDO) entry descriptions
 */
...
/**
 * \brief Object 0x1A03 (pvm TxPDO) entry descriptions
 */
...
/**
 * \brief Object 0x1A03 (pvm TxPDO) object and entry names
 *
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */      
OBJCONST UCHAR OBJMEM aName0x1A03[] = "pvm TxPDO\000\377";

	 
/**
 * \brief Object 0x1A04 (ptm RxPDO) entry descriptions
 */
...
/**
 * \brief Object 0x1A04 (ptm TxPDO) object and entry names
 *
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */      
OBJCONST UCHAR OBJMEM aName0x1A04[] = "ptm TxPDO\000\377";
/** @}*/
...
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x6071 = {DEFTYPE_INTEGER16, 0x10, ACCESS_READ};
...
{4, {0x60400010,0x60FF0020,0x60830020,0x60840020}}, /*TOBJ1603*/
{3, {0x60400010,0x60710010,0x60870020}}, /*TOBJ1604*/
/*ECATCHANGE_START(V5.11) CiA402 1*/
...
{2, {0x60410010,0x606C0020}}, /*TOBJ1A03*/
{2, {0x60410010,0x60770010}},/*TOBJ1A04*/
...
/*ECATCHANGE_END(V5.11) CiA402 1*/
   ...
   {NULL,NULL, 0x1602, {DEFTYPE_PDOMAPPING, 2 | (OBJCODE_REC << 8)}, asEntryDesc0x1602, aName0x1602, NULL, NULL, NULL, 0x0000 },
	  /* Object 0x1604 */
   {NULL,NULL, 0x1603, {DEFTYPE_PDOMAPPING, 4 | (OBJCODE_REC << 8)}, asEntryDesc0x1603, aName0x1603, NULL, NULL, NULL, 0x0000 },
	 /* Object 0x1604 */
    {NULL,NULL, 0x1604, {DEFTYPE_PDOMAPPING, 3 | (OBJCODE_REC << 8)}, asEntryDesc0x1604, aName0x1604, NULL, NULL, NULL, 0x0000 },
	 /*ECATCHANGE_START(V5.11) CiA402 1*/
   /* Object 0x1A00 */
...
/*ECATCHANGE_END(V5.11) CiA402 1*/
   ...
   /* Object 0x1A03 */
   {NULL,NULL, 0x1A03, {DEFTYPE_PDOMAPPING, 2 | (OBJCODE_REC << 8)}, asEntryDesc0x1A03, aName0x1A03, NULL, NULL, NULL, 0x0000 },	
	 /* Object 0x1A04 */
   {NULL,NULL, 0x1A04, {DEFTYPE_PDOMAPPING, 2 | (OBJCODE_REC << 8)}, asEntryDesc0x1A04, aName0x1A04, NULL, NULL, NULL, 0x0000 },		 
	 /* Object 0x603F */
